				...
				<div class="overlap" id="sing-up" >
				  <input type="hidden" name="sessionRemove" value="sessionRemove"/>
				 	<span class="input-group">Nazwa użytkownika:<span style="color: red;">*</span></span>
			 	 	...
			 	 	<span class="input-group">E-mail:<span style="color: red;">*</span></span>
			  		<input type="email" name="email" class="form-control" value="${userModelForm.email}" required autofocus />
				 	...
				 	<span class="input-group">Powtórz hasło:<span style="color: red;">*</span></span>
				 	<div class="input-group">
			  			<input type="password" class="form-control" id="passwordfield2" name="repeat-password" value="${userModelForm.repeatPassword}" required autofocus />
			  		...
			  		<br>
			  		<button type="submit" class="btn btn-default" style="width: 200px; margin-bottom: 10px;">Zarejestruj się</button>
				</div>
			</form>
