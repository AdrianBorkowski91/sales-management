...
<html>
  ...
  <body>
	...
	<%@ include file="../fragment/navbar.jspf" %>
   	...
   	<form method="post" action="myclients-new">
	<div align="center">
		<h3 align="center" style="display: inline-block; margin-top: 5px;">Nowy klient</h3>
	</div>
	...
	<ol class="breadcrumb">
		<li><a href="#"><button type="submit" name="button" value="return" style=" background-color: transparent; border: 0px solid;">Lista klientów</button></a></li>
  		<li class="active">Nowy klient</li>
	</ol>
			...
			<div class="panel panel-primary" >
				...
				<label style="margin-bottom: 9px;">Dane kontaktowe</label>
				  ...
				  <div align="center" class="input-group" style="width: 30%; margin-top:10px; display: inline-block;" >
					  <button type="submit" name="button" value="save"  class="btn btn-primary" style="width: 200px;"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>Zapisz</button>
				  </div>	
				</div>	
